...
eventos = {
    ...
    "1872 - Herança & Europa": "Após perder os pais, mudou-se para Paris e assumiu a gestão da fortuna da "
    "família.",
    "1873-1930 - Carteira Global": "Investiu em títulos, ações e ferrovias em 13 países"
    " e 7 moedas diferentes.",
    "1930 - Legado": "Faleceu deixando sua fortuna para causas sociais e educacionais no Brasil.",
    "Curiosidade": "A Herança de Eufrásia levou 20 anos para distribuir em 7 paises diferentes.",
    "Legado De Eufrásia": "Eufrásia se relacionou com Joaquim Nabuco, mas não se casou pois se casasse os "
    "bens seriam divididos.",
}
